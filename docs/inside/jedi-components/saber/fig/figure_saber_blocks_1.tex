...
\path (s3)+(2.4,0.0) \saberblock{4}{SABER\\block 1\\(TL)};
\path (s4)+(2.4,0.0) \saberblock{5}{SABER\\block 1\\(AD)};
\path (s5)+(2.4,0.0) \saberblock{6}{SABER\\block 2\\(AD)};
...
\path [line] (s5.west) -- (s4.east) node[] {};
\path [line] (s6.west) -- (s5.east) node[] {};
