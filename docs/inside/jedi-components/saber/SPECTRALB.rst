...
.. toctree::
   ...
   SPECTRALB_HorizontalLocalization.rst
...
- :ref:`horizontal localization in spectral space <spectralb_horizontal_localization>`: horizontal localization applied in spectral space.
