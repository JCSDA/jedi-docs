...
The **default** method uses the standard ICAO atmosphere.
The **NCAR** method uses a fast approximation for pressures > 120 hPa.

The following constants are used in the calculations:

- :math:`g`: gravitational constant = 9.80665 m/s\ :sup:`2`
- :math:`r_d`: specific gas constant for dry air = 287.05 J/K/kg
...
At pressures :math:`\leq` 120hPa (~15km) use the ICAO atmosphere.
