...
:math:`d_{\text{rh}}` is the :code:`relative humidity density`,
...
of the level,
:math:`RH` is the relative humidity of the level,
...
:code:`relative humidity density` - float value (default 1.0) to control the rh weight.
