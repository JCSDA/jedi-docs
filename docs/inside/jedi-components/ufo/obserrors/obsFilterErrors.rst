...
Using filters to specify observation uncertainties
==================================================
...
Also, within filters there is the ability to set observation uncertainties using the :code:`assign error` documented in :ref:`qc-filter-options`.  An example of this, from the surface observation code when assigning errors to ``stationPressure``, is included here:
