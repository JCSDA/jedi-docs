.. _top-vader-recipe-hydrostaticexnerlevelsa:
...
* **Input Variables**: height_above_mean_sea_level_levels, virtual_potential_temperature, air_pressure_levels
* **Trajectory Variables**: height_above_mean_sea_level_levels, virtual_potential_temperature, air_pressure_levels, hydrostatic_exner_levels
