.. _top-vader-recipe-particulatematter2p5a:

PM2.5 fields from CMAQ aerosols scheme AERO6 version
====================================================

* **Description**: Produces PM2.5 fields from CMAQ aerosols scheme AERO6 version
* **Name**: ParticulateMatter2p5_A
* **Variable produced**: mass_density_of_particulate_matter_2p5_in_air
* **Input Variables**:
