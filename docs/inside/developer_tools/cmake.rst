...
As before, the steps shown in this section are only necessary if you are working outside preconfigured JEDI environments or containers, and when not following the recommendation to use `spack-stack v1.9 <https://spack-stack.readthedocs.io/en/1.9.1/>`_ to set up your environment.
